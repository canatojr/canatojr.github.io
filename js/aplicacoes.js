  ...
  {    
    ...
    */
    ...
    escreveForcas(pontoE, pontoF, pontoG, pontoH);
     ...
     desenhaReta(pontoQ[0], pontoQ[1], pontoR[0], pontoR[1], "#DAA520", 10, "1");
     //pontoR define a linha pontilhada perpendicular a Px e pontoQ a linha pontilhada perpendicular a Py
